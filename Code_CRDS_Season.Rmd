...
### ANOVA/KW Adj P
p.adjust(c(0.187, 0.551, 0.17, 0.0687), "BH")
  # 0.2493333 0.5510 0.2493333 0.2493333
```
...
inu.delta.plot <- ggplot(inu.all, aes(x=X_Mean, y=Y_Mean, color=Season)) +
   geom_line(aes(linetype=Antibiotics), size=1, show.legend = F) +
...
tiff("delta.curves.tiff", width = 300, height = 125, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(1,2, widths = c(1, 1.2))))
