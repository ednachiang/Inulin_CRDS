...
kruskal.test(formula = MaxD ~ Season, data = d.sal.abx)
  # p-value = 0.04615*
dunn.test(x = as.numeric(d.sal.abx$MaxD), g = as.factor(d.sal.abx$Season), method = "bh", label = T)
  # Summer-Winter = 0.0263
  # Summer-Spring = 0.0630
  # Winter-Spring = 0.2662

# Saline No ABX
summary(aov(formula = MaxD ~ Season, data = d.sal.noabx))
  # p-value = 0.0452*
TukeyHSD(aov(formula = MaxD ~ Season, data = d.sal.noabx))
  # Summer-Winter = 0.0359449*
  # Summer-Spring = 0.2943738
  # Spring-Winter = 0.4511079
...
fligner.test(MaxD ~ Season, d.sal.abx)
  # p-value = 0.5107
leveneTest(MaxD ~ Season, d.sal.noabx)
  # p-value = 0.5111
```
...
# Saline
kruskal.test(formula = TimeMaxD ~ Season, data = d.sal.abx)
  # p-value = 0.001572*
dunn.test(x = as.numeric(d.sal.abx$TimeMaxD), g = as.factor(d.sal.abx$Season), method = "bh", label = T)
  # Summer-Winter = 0.0005*
  # Summer-Spring = 0.0903
  # Winter-Spring = 0.0233*
...
fligner.test(TimeMaxD ~ Season, d.inu.noabx)
  # p-value = 0.5083
fligner.test(TimeMaxD ~ Season, d.sal.abx)
  # p-value = 0.4475
