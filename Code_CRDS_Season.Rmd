...
#tiff("crds.AUC.png", width = 200, height = 75, units = "mm", res = 600)
grid.newpage()
...
# No ABX
res <- resid(lm(AvgDelta ~ Season, crds.inu.noabx))
hist(res)
qqnorm(res)
qqline(res)
shapiro.test(res)
  # Normal
leveneTest(AvgDelta ~ Season, crds.inu.noabx)
  # p = 0.05287
summary(aov(AvgDelta ~ Season, crds.inu.noabx))
  # p = 0.0784

# ABX
res <- resid(lm(AvgDelta ~ Season, crds.inu.abx))
hist(res)
qqnorm(res)
qqline(res)
shapiro.test(res)
  # Normal
leveneTest(AvgDelta ~ Season, crds.inu.abx)
  # p = 0.331
summary(aov(AvgDelta ~ Season, crds.inu.abx))
  # p = 0.757
...
# No ABX
res <- resid(lm(AvgDelta ~ Season, crds.sal.noabx))
hist(res)
qqnorm(res)
qqline(res)
shapiro.test(res)
  # p = 0.005062
  # Not Normal
fligner.test(AvgDelta ~ Season, crds.sal.noabx)
  # p = 0.1024
kruskal.test(AvgDelta ~ Season, crds.sal.noabx)
  # p = 0.1006

# ABX
res <- resid(lm(AvgDelta ~ Season, crds.sal.abx))
hist(res)
qqnorm(res)
qqline(res)
shapiro.test(res)
  # Normal
leveneTest(AvgDelta ~ Season, crds.sal.abx)
  # p = 0.8285
summary(aov(AvgDelta ~ Season, crds.sal.abx))
  # p = 0.0481
TukeyHSD(aov(AvgDelta ~ Season, crds.sal.abx))
  # Summer-Winter adj p = 0.0486751; CI = -2.2426872 - -0.00619378
  # Summer-Spring adj p = 0.1548176; CI = -1.8711392 - 0.26127355
  # Winter-Spring adj p = 0.7398247; CI = -0.7987391 - 1.43775433
```
...
# Steal Season legend
season.legend <- g_legend(ggplot(crds.inu, aes(x = Season, y = AvgDelta, color = Season, fill = Season)) +
                            geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
                                         position = position_dodge(0.7), stackratio = 0.5) +
                            scale_color_manual(values = c("#c98b00", "#006096", "#00966d")) +
                            scale_fill_manual(values = c("#E69F00", "#0072B2", "#00bf8b")) +
...
# Steal ABX legend
abx.legend <- g_legend(ggplot(crds.inu, aes(x = Season, y = AvgDelta, fill = Antibiotics)) + 
                         geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5, 
                                      position = position_dodge(0.7), stackratio = 0.5) +
                         scale_fill_manual(values = c("black", "white")) +
                            theme(legend.title = element_text(size=10, face="bold"),
...
# Inulin
inu.avgD.plot <- ggplot(crds.inu, aes(x = Season, y = AvgDelta, color = SeasonABX,
                                    fill = SeasonABX)) +
  geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
               position = position_dodge(0.7), stackratio = 0.5) +
  scale_color_manual(values = c("#c98b00", "#E69F00", "#004166", "#006299", "#00966d",
...
# Saline
sal.avgD.plot <- ggplot(crds.sal, aes(x = Season, y = AvgDelta, color = SeasonABX,
                                    fill = SeasonABX)) +
  geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
               position = position_dodge(0.7), stackratio = 0.5) +
  scale_color_manual(values = c("#c98b00", "#E69F00", "#004166", "#006299", "#00966d",
...
#tiff("crds.avgD.png", width = 200, height = 75, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,3, widths = c(1, 1, 0.3))))
...
#tiff("crds.maxD.png", width = 200, height = 75, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,3, widths = c(1, 1, 0.3))))
...
#tiff("crds.slope.png", width = 200, height = 75, units = "mm", res = 600)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,3, widths = c(1, 1, 0.3))))
