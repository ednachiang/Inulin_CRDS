...
leveneTest(AUC_sqrt ~ Season, crds.inu.noabx)
  # p = 0.1853
var.ci(crds.inu.noabx$AUC_sqrt, crds.inu.noabx$Season)
...
leveneTest(AUC_sqrt ~ Season, crds.inu.abx)
  # p = 0.248
var.ci(crds.inu.abx$AUC_sqrt, crds.inu.abx$Season)
...
leveneTest(AUC_sqrt ~ Season, crds.sal.noabx)
  # p = 0.708
var.ci(crds.sal.noabx$AUC_sqrt, crds.sal.noabx$Season)
...
leveneTest(AUC_sqrt ~ Season, crds.sal.abx)
  # p = 0.2885
var.ci(crds.sal.abx$AUC_sqrt, crds.sal.abx$Season)
...
### Variance Adj P
p.adjust(c(0.1853, 0.248, 0.708, 0.2885), "BH")
  # 0.3846667 0.3846667 0.7080000 0.3846667
...
leveneTest(AvgD ~ Season, crds.inu.noabx)
  # p = 0.07392
var.ci(crds.inu.noabx$AvgD, crds.inu.noabx$Season)
...
leveneTest(AvgD ~ Season, crds.inu.abx)
  # p = 0.3443
var.ci(crds.inu.abx$AvgD, crds.inu.abx$Season)
...
leveneTest(AvgD ~ Season, crds.sal.noabx)
  # p = 0.2501
var.ci(crds.sal.noabx$AvgD, crds.sal.noabx$Season)
...
leveneTest(AvgD ~ Season, crds.sal.abx)
  # p = 0.3653
var.ci(crds.sal.abx$AvgD, crds.sal.abx$Season)
...
### Variance Adj P
p.adjust(c(0.07392, 0.3443, 0.2501, 0.3653), "BH")
  # 0.133, 0.593, 0.154, 0.195
...
leveneTest(MaxD ~ Season, crds.inu.noabx)
  # p = 0.1128
var.ci(crds.inu.noabx$MaxD, crds.inu.noabx$Season)
...
leveneTest(MaxD ~ Season, crds.inu.abx)
  # p = 0.2858
var.ci(crds.inu.abx$MaxD, crds.inu.abx$Season)
...
leveneTest(MaxD ~ Season, crds.sal.noabx)
  # p = 0.5581
var.ci(crds.sal.noabx$MaxD, crds.sal.noabx$Season)
...
leveneTest(MaxD ~ Season, crds.sal.abx)
  # p = 0.3404
var.ci(crds.sal.abx$MaxD, crds.sal.abx$Season)
...
### Variance Adj P
p.adjust(c(0.1128, 0.2858, 0.5581, 0.3404), "BH")
  # 0.4512000 0.4538667 0.5581000 0.4538667
...
leveneTest(MaxSlope ~ Season, crds.inu.noabx)
  # p = 0.1685
var.ci(crds.inu.noabx$MaxSlope, crds.inu.noabx$Season)
...
leveneTest(MaxSlope ~ Season, crds.inu.abx)
  # p = 0.003141
var.ci(crds.inu.abx$MaxSlope, crds.inu.abx$Season)
...
leveneTest(MaxSlope ~ Season, crds.sal.noabx)
  # p = 0.208
var.ci(crds.sal.noabx$MaxSlope, crds.sal.noabx$Season)
...
leveneTest(MaxSlope ~ Season, crds.sal.abx)
  # p = 0.3131
var.ci(crds.sal.abx$MaxSlope, crds.sal.abx$Season)
...
### Variance Adj P
p.adjust(c(0.1685, 0.003141, 0.208, 0.3131), "BH")
  # 0.2773333 0.0125640 0.2773333 0.3131000
