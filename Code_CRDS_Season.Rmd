...
d.metrics[,colnames(meta)[3:13]] <- NA
for(sq in 1:nrow(d.metrics)){
  meta.row <- which(meta$ID == d.metrics$ID[sq])
  d.metrics[sq, 6:16] <- meta[meta.row, 3:13]
}
...
# Inulin ABX
kruskal.test(formula = MaxD ~ Season, data = d.inu.abx)
  # p-value = 0.8123

# Inulin No ABX
summary(aov(MaxD ~ Season, data = d.inu.noabx))
  # p-value = 0.0036
TukeyHSD(aov(MaxD ~ Season, data = d.inu.noabx))
  # Summer-Spring = 0.4333231
  # Winter-Spring = 0.0030199*
  # Winter-Summer = 0.0442557*

# Saline ABX
kruskal.test(formula = MaxD ~ Season, data = d.sal.abx)
  # p-value = 0.1246

# Saline No ABX
kruskal.test(formula = MaxD ~ Season, data = d.sal.noabx)
  # p-value = 0.3524
...
### Test Variance
fligner.test(MaxD ~ Season, d.inu.abx)
  # p-value = 0.02643*
fligner.test(MaxD ~ Season, d.inu.abx[which(d.inu.abx$Season != "Spring"),])
  # Summer vs. Winter
  # p-value = 0.003642
  # adj p = 0.010926*
fligner.test(MaxD ~ Season, d.inu.abx[which(d.inu.abx$Season != "Winter"),])
  # Summer vs. Spring
  # p-value = 0.1438
  # adj p = 0.215700
fligner.test(MaxD ~ Season, d.inu.abx[which(d.inu.abx$Season != "Summer"),])
  # Spring vs. Winter
  # p-value = 0.8838
  # adj p = 0.883800
p.adjust( c(0.003642, 0.1438, 0.8838), "BH")


leveneTest(MaxD ~ Season, d.inu.noabx)
  # p-value = 0.05409
fligner.test(MaxD ~ Season, d.sal.abx)
  # p-value = 0.2829
fligner.test(MaxD ~ Season, d.sal.noabx)
  # p-value = 0.2457
```
...
# Steal Season legend
season.legend <- g_legend(ggplot(d.inu, aes(x = Season, y = MaxD, color = Season, fill = Season)) +
...
# Steal ABX legend
abx.legend <- g_legend(ggplot(d.inu, aes(x = Season, y = MaxD, fill = Antibiotics)) + 
                         geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5, 
                                      position = position_dodge(0.7), stackratio = 0.5) +
...
# Inulin
inu.MaxD.plot <- ggplot(d.inu, aes(x = Season, y = MaxD, color = SeasonABX,
                                    fill = SeasonABX)) +
  geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
               position = position_dodge(0.7), stackratio = 0.5) +
  ...
  ggtitle("Inulin")  + 
  ylab(expression("Maximum Observed"~~delta^13~"C"~"(%"[o]~")")) +
...
# Saline
sal.MaxD.plot <- ggplot(d.sal, aes(x = Season, y = MaxD, color = SeasonABX,
                                    fill = SeasonABX)) +
  geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
               position = position_dodge(0.7), stackratio = 0.5) +
  scale_color_manual(values = c("#c98b00", "#E69F00", "#004166", "#006299", "#00966d",
...
#png("d.maxD.png", width = 200, height = 75, units = "mm", res = 400)
grid.newpage()
...
#png("d.MaxD.png", width = 170, height = 75, units = "mm", res = 300)
```
...
# Inulin
kruskal.test(formula = TimeMaxD ~ Season, data = d.inu.abx)
  # p-value = 0.1145
kruskal.test(formula = TimeMaxD ~ Season, data = d.inu.noabx)
  # p-value = 0.3363

# Saline
summary(aov(formula = TimeMaxD ~ Season, data = d.sal.abx))
  # p-value = 0.000249*
TukeyHSD(aov(formula = TimeMaxD ~ Season, data = d.sal.abx))
  # Summer-Winter = 0.0001683*
  # Summer-Spring = 0.0515143
  # Winter-Spring = 0.0252352*
summary(aov(formula = TimeMaxD ~ Season, data = d.sal.noabx))
  # p-value = 0.977
...
### Test Variance
fligner.test(TimeMaxD ~ Season, d.inu.abx)
  # p-value = 0.7034
fligner.test(TimeMaxD ~ Season, d.inu.noabx)
  # p-value = 0.5083
leveneTest(TimeMaxD ~ Season, d.sal.abx)
  # p-value = 0.2609
leveneTest(TimeMaxD ~ Season, d.sal.noabx)
  # p-value = 0.9561
```
...
# Steal Season legend
season.legend <- g_legend(ggplot(d.inu, aes(x = Season, y = TimeMaxD, color = Season, fill = Season)) +
                            geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
                                         position = position_dodge(0.7), stackratio = 0.5) +
                            scale_color_manual(values = c("#c98b00", "#006096", "#00966d")) +
                            scale_fill_manual(values = c("#E69F00", "#0072B2", "#00bf8b")) +
...
# Steal ABX legend
abx.legend <- g_legend(ggplot(d.inu, aes(x = Season, y = TimeMaxD, fill = Antibiotics)) + 
                         geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5, 
                                      position = position_dodge(0.7), stackratio = 0.5) +
                         scale_fill_manual(values = c("black", "white")) +
                            theme(legend.title = element_text(size=10, face="bold"),
...
# Inulin
inu.TimeMaxD.plot <- ggplot(d.inu, aes(x = Season, y = TimeMaxD, color = SeasonABX,
                                    fill = SeasonABX)) +
  geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
               position = position_dodge(0.7), stackratio = 0.5) +
  scale_color_manual(values = c("#c98b00", "#E69F00", "#004166", "#006299", "#00966d",
  ...
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1), geom = "pointrange",
               color = "black", position = position_dodge(0.7), size = 0.5) +
  ggtitle("Inulin")  + 
  ylab(expression("Time of maximum observed"~~delta^13~"C (hr)")) +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        strip.background = element_blank(),
        axis.title.x = element_text(face="bold", size=10, margin = margin(t = 7.5)),
...
# Saline
sal.TimeMaxD.plot <- ggplot(d.sal, aes(x = Season, y = TimeMaxD, color = SeasonABX,
                                    fill = SeasonABX)) +
  geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
               position = position_dodge(0.7), stackratio = 0.5) +
  scale_color_manual(values = c("#c98b00", "#E69F00", "#004166", "#006299", "#00966d",
...
#png("d.TimeMaxD.png", width = 200, height = 80, units = "mm", res = 400)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,3, widths = c(1, 1, 0.3))))

print(inu.TimeMaxD.plot, vp=viewport(layout.pos.row=1:2, layout.pos.col=1))
grid.text("A", x=unit(0.065, "npc"), y=unit(0.93, "npc"), 
          vp=viewport(layout.pos.row=1, layout.pos.col=1), gp=gpar(fontsize=20,fontface="bold"))


print(sal.TimeMaxD.plot, vp=viewport(layout.pos.row=1:2, layout.pos.col=2))
grid.text("B", x=unit(0.065, "npc"), y=unit(0.93, "npc"),
          vp=viewport(layout.pos.row=1, layout.pos.col=2), gp=gpar(fontsize=20,fontface="bold"))
...
#png("d.TimeMaxD.png", width = 170, height = 75, units = "mm", res = 300)
```
...
### Test Variance
leveneTest(Slope ~ Season, d.inu.abx)
  # p-value = 0.1217
leveneTest(Slope ~ Season, d.inu.noabx)
  # p-value = 0.3009
...
d.inu.p.noabx <- d.inu.noabx[which(d.inu.noabx$Season == "Spring"),]
d.inu.p.noabx$Day <- substr(d.inu.p.noabx$Date_Sampled, 3, 4)
d.inu.p.noabx$Day[1] <- 8
d.inu.p.noabx$Day <- as.numeric(d.inu.p.noabx$Day)

# Spearman Correlation
cor.test(d.inu.p.noabx$Slope, d.inu.p.noabx$Day, method = "spearman")
  # p-value = 0.9635
  # rho = -0.03571429
...
#png("d.slope.png", width = 200, height = 75, units = "mm", res = 400)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,3, widths = c(1, 1, 0.3))))
...
kruskal.test(SlopeTime ~ Season, data = d.inu.abx)
  # p-value = 0.06022
summary(aov(SlopeTime ~ Season, data = d.inu.noabx))
  # p-value = 0.546
kruskal.test(formula = SlopeTime ~ Season, data = d.sal.abx)
  # p-value = 0.839
summary(aov(SlopeTime ~ Season, data = d.sal.noabx))
  # p-value = 0.575
...
# Inulin ABX
fligner.test(SlopeTime ~ Season, d.inu.abx)
  # p-value = 0.02879*
fligner.test(SlopeTime ~ Season, d.inu.abx[which(d.inu.abx$Season != "Spring"),])
  # Summer vs. Winter
  # p-value = 0.003586
  # adj p = 0.010758*
fligner.test(SlopeTime ~ Season, d.inu.abx[which(d.inu.abx$Season != "Winter"),])
  # Summer vs. Spring
  # p-value = 0.1422
  # adj p = 0.213300
fligner.test(SlopeTime ~ Season, d.inu.abx[which(d.inu.abx$Season != "Summer"),])
  # Winter vs. Spring
  # p-value = 0.9815
  # adj p = 0.981500
p.adjust(c(0.003586, 0.1422, 0.9815), "BH")


leveneTest(SlopeTime ~ Season, d.inu.noabx)
  # p-value = 0.07205
fligner.test(SlopeTime ~ Season, d.sal.abx)
  # p-value = 0.9563
leveneTest(SlopeTime ~ Season, d.sal.noabx)
  # p-value = 0.4775
...
# Spearman Correlation
cor.test(d.inu.p.noabx$SlopeTime, d.inu.p.noabx$Day, method = "spearman")
  # p-value = 0.7825
  # rho = 0.1428571
...
# Steal Season legend
season.legend <- g_legend(ggplot(d.inu, aes(x = Season, y = SlopeTime, color = Season, fill = Season)) +
                            geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
                                         position = position_dodge(0.7), stackratio = 0.5) +
                            scale_color_manual(values = c("#c98b00", "#006096", "#00966d")) +
                            scale_fill_manual(values = c("#E69F00", "#0072B2", "#00bf8b")) +
...
# Steal ABX legend
abx.legend <- g_legend(ggplot(d.inu, aes(x = Season, y = SlopeTime, fill = Antibiotics)) + 
                         geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5, 
                                      position = position_dodge(0.7), stackratio = 0.5) +
                         scale_fill_manual(values = c("black", "white")) +
                            theme(legend.title = element_text(size=10, face="bold"),
...
# Inulin
inu.SlopeTime.plot <- ggplot(d.inu, aes(x = Season, y = SlopeTime, color = SeasonABX,
                                    fill = SeasonABX)) +
  geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
               position = position_dodge(0.7), stackratio = 0.5) +
  scale_color_manual(values = c("#c98b00", "#E69F00", "#004166", "#006299", "#00966d",
  ...
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1), geom = "pointrange",
               color = "black", position = position_dodge(0.7), size = 0.5) +
  ggtitle("Inulin")  + 
  ylab(expression("Time of maximum observed"~~delta^13~"C slope (hr)")) +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        strip.background = element_blank(),
        axis.title.x = element_text(face="bold", size=10, margin = margin(t = 7.5)),
...
# Saline
sal.SlopeTime.plot <- ggplot(d.sal, aes(x = Season, y = SlopeTime, color = SeasonABX,
                                    fill = SeasonABX)) +
  geom_dotplot(binaxis = 'y', stackdir = 'center', dotsize = 1.5,
               position = position_dodge(0.7), stackratio = 0.5) +
  scale_color_manual(values = c("#c98b00", "#E69F00", "#004166", "#006299", "#00966d",
...
#png("d.SlopeTime.png", width = 200, height = 90, units = "mm", res = 400)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,3, widths = c(1, 1, 0.3))))

print(inu.SlopeTime.plot, vp=viewport(layout.pos.row=1:2, layout.pos.col=1))
grid.text("A", x=unit(0.065, "npc"), y=unit(0.93, "npc"), 
          vp=viewport(layout.pos.row=1, layout.pos.col=1), gp=gpar(fontsize=20,fontface="bold"))


print(sal.SlopeTime.plot, vp=viewport(layout.pos.row=1:2, layout.pos.col=2))
grid.text("B", x=unit(0.065, "npc"), y=unit(0.93, "npc"),
          vp=viewport(layout.pos.row=1, layout.pos.col=2), gp=gpar(fontsize=20,fontface="bold"))
...
#png("d.SlopeTime.png", width = 170, height = 75, units = "mm", res = 300)
```
...
summary(aov(formula = AUC ~ Season, data=auc.inu.abx))
  # p-value = 0.883
summary(aov(formula = AUC ~ Season, data=auc.sal.abx))
  # p-value = 0.738
...
leveneTest(AUC ~ Season, auc.sal.noabx)
  # p-value = 0.7845
leveneTest(AUC ~ Season, auc.inu.abx)
  # p-value = 0.4093
leveneTest(AUC ~ Season, auc.sal.abx)
  # p-value = 0.6819
...
### Test Spring Variance
auc.inu.p.noabx <- auc.inu.noabx[which(auc.inu.noabx$Season == "Spring"),]
auc.inu.p.noabx$Day <- substr(auc.inu.p.noabx$Date_Sampled, 3, 4)
auc.inu.p.noabx$Day[1] <- 8
auc.inu.p.noabx$Day <- as.numeric(auc.inu.p.noabx$Day)

# Spearman Correlation
cor.test(auc.inu.p.noabx$AUC, auc.inu.p.noabx$Day, method = "spearman")
  # p-value = 0.2
  # rho = -0.5714286
...
#png("auc.png", width = 200, height = 75, units = "mm", res = 400)
grid.newpage()
pushViewport(viewport(layout=grid.layout(2,3, widths = c(1, 1, 0.3))))
...
#png("prospectus.delta.sd.curves.png", width = 240, height = 110, units = "mm", res = 400)
carb.plot
#dev.off()
```
...
# Test normality
hist(dates_use$IBA.Hib)
qqnorm(dates_use$IBA.Hib)
qqline(dates_use$IBA.Hib)
shapiro.test(dates_use$IBA.Hib)
  # p-value = 0.9558
...
# Test variance
leveneTest(IBA.Hib ~ Season, dates_use)
  # p-value = 0.6908



### Test Days_Hib in Spring
...
##### Prepare data to test correlations by Substrate + ABX #####

# Separate by substrate
dates.inu <- dates_use[which(dates_use$Substrate == "Inulin"),]
dates.inu <- dates.inu[which(dates.inu$Season == "Spring"),]
  # Only No ABX samples

#dates.sal <- dates_use[which(dates_use$Substrate == "Saline"),]
#dates.sal <- dates.sal[which(dates.sal$Season == "Spring"),]
#dates.sal.noabx <- dates.sal[which(dates.sal$Antibiotics == "No"),]
#dates.sal.abx <- dates.sal[which(dates.sal$Antibiotics == "Yes"),]


### Test normality

hist(dates.inu$Days_Hib)
qqnorm(dates.inu$Days_Hib)
qqline(dates.inu$Days_Hib)
shapiro.test(dates.inu$Days_Hib)
  # p-value = 0.814
  # Normal
hist(dates.inu$AUC)
qqnorm(dates.inu$AUC)
qqline(dates.inu$AUC)
shapiro.test(dates.inu$AUC)
  # p-value = 0.3911
  # Normal
hist(dates.inu$Slope)
qqnorm(dates.inu$Slope)
qqline(dates.inu$Slope)
shapiro.test(dates.inu$Slope)
  # p-value = 0.2886
  # Normal
...
cor.test(dates.inu$Days_Hib, dates.inu.noabx$AUC, method = "pearson")
  # p-value = 0.3325
  # cor = -0.5540971
cor.test(dates.inu$Days_Hib, dates.inu.noabx$Slope, method = "pearson")
  # p-value = 0.8691
  # cor = 0.1030024
