...
shapiro.test(res)
  # Normal
leveneTest(AUC_sqrt ~ Season, crds.sal.noabx)
  # p = 0.6215
...
### Variance Adj P
p.adjust(c(0.169, 0.3313, 0.6215, 0.6322), "BH")
  # 0.6322 0.6322 0.6322 0.6322

### ANOVA/KW Adj P
p.adjust(c(0.105, 0.557, 0.27, 0.519), "BH")
  # 0.420 0.557 0.540 0.557
```
...
leveneTest(AvgD ~ Season, crds.inu.noabx)
  # p = 0.03463
leveneTest(AvgD ~ Season, crds.inu.noabx[which(crds.inu.noabx$Season != "Spring"),])
  # Summer-Winter p = 0.9105
leveneTest(AvgD ~ Season, crds.inu.noabx[which(crds.inu.noabx$Season != "Winter"),])
  # Summer-Spring p = 0.05237
leveneTest(AvgD ~ Season, crds.inu.noabx[which(crds.inu.noabx$Season != "Summer"),])
  # Summer-Spring p = 0.03176
p.adjust(c(0.9105, 0.05237, 0.03176), "BH")
  # 0.910500 0.078555 0.078555
b2 <- two.boot(sample1 = crds.inu.noabx$AvgD[which(crds.inu.noabx$Season == "Summer")], 
         sample2 = crds.inu.noabx$AvgD[which(crds.inu.noabx$Season == "Winter")],
         FUN = var, R = 9999)
boot.ci(b2, conf = 0.95, type = "bca")
  # Summer-Winter CI = -105085,  200989
b2 <- two.boot(sample1 = crds.inu.noabx$AvgD[which(crds.inu.noabx$Season == "Summer")], 
         sample2 = crds.inu.noabx$AvgD[which(crds.inu.noabx$Season == "Spring")],
         FUN = var, R = 9999)
boot.ci(b2, conf = 0.95, type = "bca")
  # Summer-Spring CI = -645662, -107160
b2 <- two.boot(sample1 = crds.inu.noabx$AvgD[which(crds.inu.noabx$Season == "Spring")], 
         sample2 = crds.inu.noabx$AvgD[which(crds.inu.noabx$Season == "Winter")],
         FUN = var, R = 9999)
boot.ci(b2, conf = 0.95, type = "bca")
  # Spring-Winter CI = 189303, 663116
...
shapiro.test(res)
  # Normal
leveneTest(AvgD ~ Season, crds.sal.noabx)
  # p = 0.4167
...
TukeyHSD(aov(AvgD ~ Season, crds.sal.abx))
  # Summer-Winter adj p = 0.0643084; CI = -3.034201, 0.08159865
  # Summer-Spring adj p = 0.2321820; CI = -2.462090, 0.50870913
  # Spring-Winter adj p = 0.6856179; CI = -2.05751114, 1.058289




### Variance Adj P
p.adjust(c(0.03463, 0.3414, 0.4167, 0.2089), "BH")
  # 0.13852 0.41670 0.41670 0.41670

### ANOVA/KW Adj P
p.adjust(c(0.3096, 0.551, 0.17, 0.0687), "BH")
  # 0.4128 0.5510 0.3400 0.2748
```
...
shapiro.test(res)
  # Normal
leveneTest(MaxD ~ Season, crds.sal.noabx)
  # p = 0.4918
summary(aov(MaxD ~ Season, crds.sal.noabx))
  # p = 0.089
TukeyHSD(aov(MaxD ~ Season, crds.sal.noabx))
  # Summer-Winter adj p = 0.0822765, CI = -5.1012946, 0.2753225
  # Summer-Spring adj p = 0.7414043, CI = -3.3375526, -1.8434852
  # Spring-Winter adj p = 0.2507518, CI = -4.2564713, 0.9245666
...
leveneTest(MaxD ~ Season, crds.sal.abx)
  # p = 0.08924
leveneTest(MaxD ~ Season, crds.sal.abx[which(crds.sal.abx$Season != "Spring"),])
  # Summer - Winter = 0.1856
leveneTest(MaxD ~ Season, crds.sal.abx[which(crds.sal.abx$Season != "Winter"),])
  # Summer - Spring = 0.05623
leveneTest(MaxD ~ Season, crds.sal.abx[which(crds.sal.abx$Season != "Summer"),])
  # Spring - Winter = 0.4912
p.adjust(c(0.1856, 0.05623, 0.4912), "BH")
  # 0.27840 0.16869 0.49120
b2 <- two.boot(sample1 = crds.sal.abx$MaxD[which(crds.sal.abx$Season == "Summer")], 
         sample2 = crds.sal.abx$MaxD[which(crds.sal.abx$Season == "Winter")],
         FUN = var, R = 9999)
boot.ci(b2, conf = 0.95, type = "bca")
  # Summer-Winter CI = 0.045,  3.825
b2 <- two.boot(sample1 = crds.sal.abx$MaxD[which(crds.sal.abx$Season == "Summer")], 
         sample2 = crds.sal.abx$MaxD[which(crds.sal.abx$Season == "Spring")],
         FUN = var, R = 9999)
boot.ci(b2, conf = 0.95, type = "bca")
  # Summer-Spring CI = 0.523,  4.109
b2 <- two.boot(sample1 = crds.sal.abx$MaxD[which(crds.sal.abx$Season == "Spring")], 
         sample2 = crds.sal.abx$MaxD[which(crds.sal.abx$Season == "Winter")],
         FUN = var, R = 9999)
boot.ci(b2, conf = 0.95, type = "bca")
  # Spring-Winter CI = -0.9991,  0.1838
...
### Variance Adj P
p.adjust(c(0.1326, 0.309, 0.4918, 0.08924), "BH")
  # 0.2652 0.4120 0.4918 0.2652

### ANOVA/KW Adj P
p.adjust(c(0.0143, 0.994, 0.089, 0.106), "BH")
  # 0.0572000 0.9940000 0.1413333 0.1413333
```
...
TukeyHSD(aov(MaxSlope ~ Season, crds.inu.noabx))
  ...
  # Spring-Winter adj p = 0.0005968; CI = 630.7837 - 2189.6482
...
TukeyHSD(aov(MaxSlope ~ Season, crds.inu.abx))
  # Summer-Winter adj p = 0.0006236; CI = -161.45568, -47.52180
  # Summer-Spring adj p = 0.0028911; CI = -144.93614, -31.00226
  # Spring-Winter adj p = 0.6965862; CI =  -68.52300,  35.48392
...
qqline(res)
shapiro.test(res)
  # Test says not normal, but it's only because of 2 outliers
  # Normal
leveneTest(MaxSlope ~ Season, crds.sal.noabx)
  # p = 0.2406
...
### Variance Adj P
p.adjust(c(0.1476, 0.1861, 0.2406, 0.3917), "BH")
  # 0.3208 0.3208 0.3208 0.3917

### ANOVA/KW Adj P
p.adjust(c(0.00069, 0.000574, 0.71, 0.415), "BH")
  # 0.00138 0.00138 0.71000 0.5533333
...
inu.delta.plot <- ggplot(inu.all, aes(x=BinTime, y=Y_Mean, color=Season)) +
  ...
  geom_errorbarh(aes(xmin = X_Mean-X_SD, xmax = X_Mean+X_SD),
