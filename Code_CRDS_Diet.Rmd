...
### Summer Saline ABX
# T-tests
p.adjust(c(0.9143, 0.3431, 0.1279, 0.1291, 0.01531), "BH")
  # 0.9143000 0.4288750 0.2151667 0.2151667 0.0765500

# F-tests
p.adjust(c(0.3087, 0.3737, 0.4416, 0.741, 0.6804), "BH")
  # 0.736 0.736 0.736 0.741 0.741


### Spring Saline No ABX
p.adjust(c(0.1306, 0.1822, 0.2265, 0.01552, 0.1995), "BH")
  # 0.2265 0.2265 0.2265 0.0776 0.2265

# F-tests
p.adjust(c(0.1722, 0.5353, 0.4852, 0.8439, 0.3409), "BH")
