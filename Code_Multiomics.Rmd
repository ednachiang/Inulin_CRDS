...
rename[1] <- "Flavonifractor"
rename[9] <- "Micrococcales"
rename[11] <- "Ruminococcaceae"
rename[12] <- "Muribaculaceae"
rename[17] <- "Bacteroidales"
rename[18] <- "Clostridiales"
rename[22] <- "Salinivirgaceae"
rename[25] <- "Lactobacillus"
rename[27] <- "Prevotella"
rename[28] <- "Bacteroides"
...
plot_heatmap(prob.phy, sample.order = c("Acetate", "Butyrate", "Propionate", "Lactate", "Fructose", "Glucose", "Mannose", "Phenylalanine", "Glutamate", "Uracil"), taxa.label = "Taxon", taxa.order = c(10936, 10918, 10415, 9902, 9662, 8671, 8479, 8193, 7370, 6012, 5062, 5033, 4486, 3978, 3977, 3974, 3956, 3949, 3517, 2849, 2517, 2408, 1985, 1982, 1315, 59, 57, 15, 7)) +
  geom_tile(colour="gray40") +
  scale_y_discrete(labels=c("Candidatus Buchananbacteria bacterium RBG_13_39_9", "candidate division BRC1 bacterium HGW-BRC1-1", "Ignavibacteria bacterium GWF2_33_9", "Candidatus Methanoperedens nitroreducens", "HGW-Chloroflexi-5", "Micrococcales", "Jannaschia faecimaris", "Trabulsiella odontotermitis", "Oceanibaculum indicum", "Larkinella knui", "Chitinophaga barathri", "Flavobacterium sp. xlx-214", "Williamwhitmania taraxaci", "Bacteroides", "Prevotella", "Salinivirgaceae", "Muribaculaceae","Bacteroidales", "Coprobacillus sp. AM23-2", "Gracilibacillus halophilus", "Aneurinibacillus danicus", "Paenibacillus phocaensis", "Lachnospiraceae bacterium FD2005", "Clostridium paradoxum", "Halobacillus kuroshimensis", "Lactobacillus", "Flavonifractor", "Ruminococcaceae", "Clostridiales")) +
  ...
  scale_fill_gradientn(name="Co-occurence\nProbability",
                       ...
                       limits = c(-2.31, 2.61), breaks = c(-2.00, -1.50, -1.00, -0.50, 0.00, 0.50, 1.00, 1.50, 2.00, 2.50)) +
