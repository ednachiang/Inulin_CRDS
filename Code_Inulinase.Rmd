...
```{r}
### Rel Abund
mapped_all <- read.csv('eCAMI/inulinase/mapped_reads_all.csv')
...
# Variance
fligner.test(RelAbund.100000 ~ Season, data=exoMapped)
  # p-value = 0.451
fligner.test(RelAbund.100000 ~ Season, data=endo_mapped)
  # p-value = 0.3358
fligner.test(RelAbund.100000 ~ Metabolism, data=exoMapped)
  # p-value = 0.9497
fligner.test(RelAbund.100000 ~ Metabolism, data=endo_mapped)
  # p-value = 0.1653
...
### Plot - Rel Abund
```{r}
tiff("inulinase.relAbund.tiff", width = 175, height = 100, units = "mm", res = 400)
ggplot(exoMapped, aes(x=Season, y=RelAbund.100000, fill=Season)) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 1.5) +
  scale_fill_manual(name="Season", values=c("#E69F00", "#0072B2", "#00bf8b")) +
  ylab("Relative Abundance (%) *\n100000") +
  scale_y_continuous(breaks=c(1.40, 2.69, 3.98, 5.27, 6.56, 7.85),
                     limits=c(1.40, 7.85)) +
  stat_summary(fun.data = "mean_se", fun.args = list(mult = 1), geom = "pointrange",
