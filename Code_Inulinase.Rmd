...
ggplot(ags, aes(x = Season, y = Avg_Genome_Size, color=Season, fill = Season)) +
  geom_boxplot()
...
save(cla.phy, file="kaiju/inulinase/class.phy.RData")
save(ord.phy, file="kaiju/inulinase/order.phy.RData")
save(fam.phy, file="kaiju/inulinase/family.phy.RData")
save(gen.phy, file="kaiju/inulinase/genus.phy.RData")
save(spe.phy, file="kaiju/inulinase/species.phy.RData")
```
