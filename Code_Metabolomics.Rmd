...
# Drop groups with n < 3
metabplot <- metab
metabplot$Glutamate[which(metabplot$SubstrateABX == "Inulin.Yes")] <- NA
metabplot$Phenylalanine[which(metabplot$SubstrateABX == "Inulin.Yes")] <- NA
...
grid.text("F", x=unit(0.05, "npc"), y=unit(0.97, "npc"), 
...
grid.text("G", x=unit(0.05, "npc"), y=unit(1.02, "npc"), 
...
grid.text("H", x=unit(0.05, "npc"), y=unit(1.02, "npc"), 
