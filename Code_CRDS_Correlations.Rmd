...
shapiro.test(dates.inu$Days_Hib)
  # p-value = 0.07263
  # Normal
hist(dates.inu$IBA.Hib)
qqnorm(dates.inu$IBA.Hib)
qqline(dates.inu$IBA.Hib)
shapiro.test(dates.inu$IBA.Hib)
  # p-value = 0.146
  # Normal
hist(dates.inu$Num_IBA)
qqnorm(dates.inu$Num_IBA)
qqline(dates.inu$Num_IBA)
shapiro.test(dates.inu$Num_IBA)
  # p-value = 0.04046*
  # Not Normal
...
# Saline
hist(dates.sal$Days_Hib)
qqnorm(dates.sal$Days_Hib)
qqline(dates.sal$Days_Hib)
shapiro.test(dates.sal$Days_Hib)
  # p-value = 0.5374
  # Normal
hist(dates.sal$IBA.Hib)
qqnorm(dates.sal$IBA.Hib)
qqline(dates.sal$IBA.Hib)
shapiro.test(dates.sal$IBA.Hib)
  # p-value = 0.5105
  # Normal
hist(dates.sal$Num_IBA)
qqnorm(dates.sal$Num_IBA)
qqline(dates.sal$Num_IBA)
shapiro.test(dates.sal$Num_IBA)
  # p-value = 0.9989
  # Normal
hist(dates.sal$Slope)
qqnorm(dates.sal$Slope)
qqline(dates.sal$Slope)
shapiro.test(dates.sal$Slope)
  # p-value = 1.081e-06
  # Not Normal
hist(dates.sal$AUC)
qqnorm(dates.sal$AUC)
qqline(dates.sal$AUC)
shapiro.test(dates.sal$AUC)
  # p-value = 0.001118
  # Not Normal
...
# Inulin Slope
cor.test(dates.inu$Days_Hib, dates.inu$Slope, method = "spearman")
  # p-value = 0.000532*
  # rho = 0.7846294
cor.test(dates.inu$IBA.Hib, dates.inu$Slope, method = "spearman")
  # p-value = 0.6482
  # rho = -0.1285714
cor.test(dates.inu$Num_IBA, dates.inu$Slope, method = "spearman")
  # p-value = 0.009235*
  # rho = 0.6462858

# Inulin AUC
cor.test(dates.inu$Days_Hib, dates.inu$AUC, method = "spearman")
  # p-value = 0.06278*
  # rho = 0.4915105
cor.test(dates.inu$IBA.Hib, dates.inu$AUC, method = "spearman")
  # p-value = 0.4578
  # rho = -0.2071429
cor.test(dates.inu$Num_IBA, dates.inu$AUC, method = "spearman")
  # p-value = 0.2332
  # rho = 0.3276435 
...
# Saline Slope
cor.test(dates.sal$Days_Hib, dates.sal$Slope, method = "spearman")
  # p-value = 0.5597
  # rho = -0.1577012 
cor.test(dates.sal$IBA.Hib, dates.sal$Slope, method = "spearman")
  # p-value = 0.4632
  # rho = -0.1970588 
cor.test(dates.sal$Num_IBA, dates.sal$Slope, method = "spearman")
  # p-value = 0.3231
  # rho = -0.2640129

# Saline AUC
cor.test(dates.sal$Days_Hib, dates.sal$AUC, method = "spearman")
  # p-value = 0.1164
  # rho = -0.4082545
cor.test(dates.sal$IBA.Hib, dates.sal$AUC, method = "spearman")
  # p-value = 0.1764
  # rho = -0.3558824
cor.test(dates.sal$Num_IBA, dates.sal$AUC, method = "spearman")
  # p-value = 0.01614*
  # rho = -0.5899731
