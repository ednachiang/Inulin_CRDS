...
cor.test(crds.sal.noabx$AUC_sqrt, crds.sal.noabx$BodyMass, method = "kendall")
  # p = 0.4467
  # tau = -0.1345029
ci_cor(crds.sal.noabx$AUC_sqrt, crds.sal.noabx$BodyMass, method = "kendall", type = c("bootstrap"), R = 9999, boot_type = "bca")
  # -0.5092025  0.2526649
...
cor.test(crds.sal.noabx$AUC_sqrt, crds.sal.noabx$BodyTemp, method = "kendall")
  # p = 0.858
  # tau = 0.107224
ci_cor(crds.sal.noabx$AUC_sqrt, crds.sal.noabx$BodyTemp, method = "kendall", type = c("bootstrap"), R = 9999, boot_type = "bca")
  # -0.2749094  0.4817398
...
shapiro.test(res)
  # Normal
cor.test(crds.sal.abx$AUC_sqrt, crds.sal.abx$BodyTemp, method = "pearson")
  # p = 0.82
  # CI = -0.5252706  0.4333824
  # cor = -0.05969759
...
qqline(res)
shapiro.test(res)
  # Test says normal but it doesn't look normal
  # Not Normal
cor.test(crds.sal.noabx$AvgD, crds.sal.noabx$BodyMass, method = "kendall")
  # p = 0.05806
  # tau = -0.3216374
ci_cor(crds.sal.noabx$AvgD, crds.sal.noabx$BodyMass, method = "kendall", type = c("bootstrap"), R = 9999, boot_type = "bca")
  # -0.6542917  0.1012658 
...
shapiro.test(res)
  # Normal
cor.test(crds.sal.noabx$AvgD, crds.sal.noabx$BodyTemp, method = "pearson")
  # p = 0.2371
  # CI = -0.1944610  0.6544325
  # cor = 0.2849136
