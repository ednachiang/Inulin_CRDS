...
cor.test(crds.sal.abx$BodyMass, crds.sal.abx$MaxSlope, method = "pearson")
  # p = 0.3738
  # CI = -0.6401081  0.2814793
  # cor = -0.2303268



p.adjust(c(0.007431, 0.836, 0.9934, 0.3738), "BH")
  # 0.029724 0.993400 0.993400 0.747600
```
...
ci_cor(dna.c.inu.abx$DNA_Yield_.ng.mg., dna.c.inu.abx$MaxSlope, method = "kendall", type = c("bootstrap"), R = 9999, boot_type = "bca")
  # -0.09104645  0.51581509 




p.adjust(c(0.3841, 0.04198, 0.3974, 0.07956), "BH")
  # 0.39740 0.15912 0.39740 0.15912
