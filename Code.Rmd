...
inu.auc.plot <- ggplot(auc.inu, aes(x = Season, y = AUC, fill = interaction(Season, Antibiotics))) +
  geom_boxplot() +
  geom_dotplot(aes(fill = interaction(Season, Antibiotics)), binaxis = 'y', stackdir = 'center', dotsize = 0.5, stackratio = 1.15, position = position_dodge(1), color = "black") +
  ggtitle("Inulin AUC")


man.auc.plot <- ggplot(auc.man, aes(x = Season, y = AUC, fill = interaction(Season, Antibiotics))) +
  geom_boxplot() +
  geom_dotplot(aes(fill = interaction(Season, Antibiotics)), binaxis = 'y', stackdir = 'center', dotsize = 0.5, stackratio = 1.15, position = position_dodge(1), color = "black") +
  ggtitle("Mannitol AUC")


sal.auc.plot <- ggplot(auc.sal, aes(x = Season, y = AUC, fill = interaction(Season, Antibiotics))) +
  geom_boxplot() +
  geom_dotplot(aes(fill = interaction(Season, Antibiotics)), binaxis = 'y', stackdir = 'center', dotsize = 0.5, stackratio = 1.15, position = position_dodge(1), color = "black") +
  ggtitle("Saline AUC")
