...
kruskal.test(formula = AUC ~ Season, data=auc.inu.abx)
  # p-value = 0.04523
kruskalmc(resp = AUC ~ Season, data=auc.inu.abx)
  # No diff
...
p.adjust(c(2.149e-09, 2.163e-06, 0.3051), method="BH")
  # Inulin = 6.4470e-09
  # Mannitol = 3.2445e-06
  # Saline = 0.30510
# Within-substrate season kruskal-wallis test
p.adjust(c(0.04523, 0.05215, 0.07919, 0.1124, 0.02048, 0.04824), method="BH")
  # Inulin ABX = 0.078225
  # Inulin No ABX = 0.078225
  # Mannitol ABX = 0.095028
  # Mannitol No ABX = 0.112400
  # Saline ABX = 0.078225
  # Saline No ABX = 0.078225
...
hist(auc.sal.abx$AUC)
  #W42 is an outlier (female ABX winter; ABX clearly didn't work here)
auc.sal.abx <- auc.sal.abx[-which(auc.sal.abx$ID == "W42"),]
hist(auc.sal.abx$AUC)
...
leveneTest(AUC ~ Season, data=auc.sal.noabx)
  # p-value = 0.2222
fligner.test(AUC ~ Season, data=auc.sal.noabx)
  # p-value = 0.2657


### Kruskal-Wallis for Inulin - Delta values of ABX vs. no-ABX
