...
kruskal.test(formula = TimeMaxD ~ Season, data=d.inu.noabx)
  # p-value = 0.3596
summary(aov(TimeMaxD ~ Season, data = d.sal.abx))
  # p-value = 0.000249
summary(aov(TimeMaxD ~ Season, data = d.sal.noabx))
  # p-value = 0.97
...
TukeyHSD(aov(Slope ~ Season, data = d.inu.abx))
  # Summer-Spring = 0.0019327
  # Winter-Spring = 0.9797781
  # Winter-Summer = 0.0013741  
summary(aov(Slope ~ Season, data = d.inu.noabx))
  # p-value = 0.000698
TukeyHSD(aov(Slope ~ Season, data = d.inu.noabx))
  # Summer-Spring = 0.9963771
  # Winter-Spring = 0.0015118
  # Winter-Summer = 0.0025611
...
### Test
kruskal.test(formula = SlopeTime ~ Season, data = d.inu.abx)
  # p-value = 0.0768
...
p.adjust(c(0.005841, 0.01802, 0.0361, 0.2235, 0.9611, 0.0888), method = "BH")
  # Inulin = 0.035046* 0.054060 0.072200
  # Saline = 0.268200 0.961100 0.133200
...
p.adjust(c(0.002165, 0.09732, 0.002525, 0.1014, 0.05195, 0.366), method = "BH")
  # Inulin = 0.007575* 0.121680 0.007575*
  # Saline = 0.121680 0.103900 0.366000
...
fligner.test(AUC ~ Season, auc.sal.abx)
  # p-value = 0.8241
p.adjust(c(0.01405, 0.4233, 0.1303, 0.8241), method = "fdr")
  # 0.0562 0.5644 0.2606 0.8241
...
p.adjust(c(0.2006, 0.7246, 0.2156, 0.5819), method = "BH")
  # 0.4312 0.7246 0.4312 0.7246
