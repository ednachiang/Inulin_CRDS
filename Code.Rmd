...
#png("d.slope.png", width = 175, height = 75, units = "mm", res = 300)
grid.newpage()
pushViewport(viewport(layout=grid.layout(1,2, widths = c(1, 1))))
print(inu.slope.plot, vp=viewport(layout.pos.row=1, layout.pos.col=1))
print(sal.slope.plot, vp=viewport(layout.pos.row=1, layout.pos.col=2))
dev.off()
