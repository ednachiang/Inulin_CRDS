...
wilcox.test(AUC~Antibiotics, data=auc.inu)
  # p-value = 0.0001171
kruskal.test(formula = AUC ~ Season, data=auc.inu, subset = Antibiotics=="Yes")
  # p-value = 0.9168
kruskalmc(resp = AUC ~ Season, data = auc.inu, subset = Antibiotics=="Yes")
  # Spring-Winter
pairwise.wilcox.test(auc.inu$AUC, auc.inu$Season, subset = Antibiotics=="Yes")
  # Summer-Spring = 0.054
  # Winter-Spring = 0.024
  # Summer-Winter = 0.180
...
kruskal.test(formula = AUC ~ Season, data=auc.inu, subset = Antibiotics=="No")
  # p-value = 0.09011
kruskalmc(resp = AUC ~ Season, data=auc.inu, subset = Antibiotics=="No")
  # Spring-Winter
pairwise.wilcox.test(auc.inu$AUC, auc.inu$Season, subset = Antibiotics=="No")
  # Summer-Spring = 0.054
  # Winter-Spring = 0.024
  # Summer-Winter = 0.180
...
wilcox.test(AUC~Antibiotics, data=auc.man)
  # p-value = 7.173e-05
kruskal.test(formula = AUC ~ Season, data=auc.man, subset = Antibiotics=="Yes")
  # p-value = 0.8836
pairwise.wilcox.test(auc.man$AUC, auc.man$Season, subset = Antibiotics=="Yes")
  # Summer-Spring = 0.66
  # Winter-Spring = 0.66
  # Summer-Winter = 0.66
...
kruskal.test(formula = AUC ~ Season, data=auc.man, subset = Antibiotics=="No")
  # p-value = 0.2792
pairwise.wilcox.test(auc.man$AUC, auc.man$Season, subset = Antibiotics=="No")
  # Summer-Spring = 0.66
  # Winter-Spring = 0.66
  # Summer-Winter = 0.66
...
wilcox.test(AUC~Antibiotics, data=auc.sal)
  # p-value = 0.0001171
kruskal.test(formula = AUC ~ Season, data=auc.sal, subset = Antibiotics=="Yes")
  # p-value = 0.06287
kruskalmc(resp = AUC ~ Season, data=auc.sal, subset = Antibiotics=="Yes")
  # None
pairwise.wilcox.test(auc.sal$AUC, auc.sal$Season, subset = Antibiotics=="Yes")
  # Summer-Spring = 0.742
  # Winter-Spring = 0.075
  # Summer-Winter = 0.742
...
kruskal.test(formula = AUC ~ Season, data=auc.sal, subset = Antibiotics=="No")
  # p-value = 0.06906
kruskalmc(resp = AUC ~ Season, data=auc.sal, subset = Antibiotics=="No")
  # None
pairwise.wilcox.test(auc.sal$AUC, auc.sal$Season, subset = Antibiotics=="No")
  # Summer-Spring = 0.742
  # Winter-Spring = 0.075
  # Summer-Winter = 0.742
kruskal.test(formula = AUC ~ Season, data=auc.sal.noabx)
  # p-value = 0.6906
kruskalmc(resp = AUC ~ Season, data=auc.sal.noabx)
  # None
pairwise.wilcox.test(auc.sal.noabx$AUC, auc.sal.noabx$Season)
  # Summer-Spring = 0.13
  # Winter-Spring = 0.13
  # Summer-Winter = 0.63
...
p.adjust(c(0.9168,0.09011,0.8836, 0.2792, 0.06287, 0.06906), method="BH")
  # Inulin ABX = 0.91680
  # Inulin No ABX = 0.18022
  # Mannitol ABX = 0.91680
  # Mannitol No ABX = 0.41880
  # Saline ABX = 0.18022
  # Saline No ABX = 0.18022
...
auc2.noabx <- auc2.df[which(auc2.df$Antibiotics == "No"),]
auc2.inu.abx <- auc2.df[which(auc2.inu$Antibiotics == "Yes"),]
auc2.inu.noabx <- auc2.df[which(auc2.inu$Antibiotics == "No"),]
auc2.man.abx <- auc2.df[which(auc2.man$Antibiotics == "Yes"),]
auc2.man.noabx <- auc2.df[which(auc2.man$Antibiotics == "No"),]
auc2.sal.abx <- auc2.df[which(auc2.sal$Antibiotics == "Yes"),]
auc2.sal.noabx <- auc2.df[which(auc2.sal$Antibiotics == "No"),]
...
wilcox.test(AUC~Antibiotics, data=auc2.inu)
  # p-value = 0.0001171
kruskal.test(formula = AUC ~ Season, data=auc2.inu, subset = Antibiotics=="Yes")
  # p-value = 0.9168
kruskal.test(formula = AUC ~ Season, data=auc2.inu, subset = Antibiotics=="No")
  # p-value = 0.06794
kruskalmc(resp = AUC ~ Season, data=auc2.inu, subset = Antibiotics=="No")
  # Spring-Winter

# Mannitol
wilcox.test(AUC~Antibiotics, data=auc2.man)
  # p-value = 7.173e-05
kruskal.test(formula = AUC ~ Season, data=auc2.man, subset = Antibiotics=="Yes")
  # p-value = 0.7697
kruskal.test(formula = AUC ~ Season, data=auc2.man, subset = Antibiotics=="No")
  # p-value = 0.2523
...
wilcox.test(AUC~Antibiotics, data=auc2.sal)
  # p-value = 0.02334
kruskal.test(formula = AUC ~ Season, data=auc2.sal, subset = Antibiotics=="Yes")
  # p-value = 0.05411
kruskalmc(resp = AUC ~ Season, data=auc2.inu, subset = Antibiotics=="Yes")
  # Spring-Winter
kruskal.test(formula = AUC ~ Season, data=auc2.sal, subset = Antibiotics=="No")
  # p-value = 0.07628
kruskalmc(resp = AUC ~ Season, data=auc2.inu, subset = Antibiotics=="No")
  # Spring-Winter
...
### Kruskal-Wallis BH-adjusted p-values
# Within-substrate ABX wilcoxon test
p.adjust(c(0.0001171, 7.173e-050, 02334), method="BH")
  # Inulin = 1.7565e-04
  # Mannitol = 2.1519e-49
  # Saline = 1
# Within-substrate season kruskal-wallis test
