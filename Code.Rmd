...
tiff("crds.mdtp2.tiff", width = 12.75, height = 5, units = "in", res = 300)
carb.plot
dev.off()
```
...
p.adjust(c(2.4e-06, 3.018e-06, 0.1882), method="BH")
  # Inulin = 4.527e-06
  # Mannitol = 4.527e-06
  # Saline = 0.1882
# Within-substrate season kruskal-wallis test
p.adjust(c(0.309, 0.03649, 0.2487, 0.0962, 0.03039, 0.2256), method="BH")
  # Inulin ABX = 0.30900
  # Inulin No ABX = 0.10947
  # Mannitol ABX = 0.29844
  # Mannitol No ABX = 0.19240
  # Saline ABX = 0.10947
  # Saline No ABX = 0.29844
...
pairwise.wilcox.test(max.inu.noabx$Delta, max.inu.noabx$Season, method="BH")
  ...
  # Winter-Spring = 0.0075
  # Summer-Winter = 0.0019
...
wilcox.test(Delta~Antibiotics, data=max.sal)
  # p-value = 0.3424
kruskalmc(resp = Delta ~ Season, data=max.sal.abx)
  # p-value = 0.02766
kruskalmc(resp = Delta ~ Season, data=max.sal.abx)
  # No diff
...
### Kruskal-Wallis BH-adjusted p-values
# Within-substrate ABX wilcoxon test
p.adjust(c(1.115e-06, 1.897e-05, 0.3424), method="BH")
  # Inulin = 3.3450e-06
  # Mannitol = 2.8455e-05
  # Saline = 0.34240
# Within-substrate season kruskal-wallis test
p.adjust(c(0.862, 0.002215, 0.225, 0.05701, 0.02766, 0.4557), method="BH")
  # Inulin ABX = 0.86200
  # Inulin No ABX = 0.01329
  # Mannitol ABX = 0.33750
  # Mannitol No ABX = 0.11402
  # Saline ABX = 0.08298
  # Saline No ABX = 0.54684
...
### Kruskal-Wallis BH-adjusted p-values
# Within-substrate ABX wilcoxon test
p.adjust(c(1.39e-06, 0.00232, 0.7529), method="BH")
  # Inulin = 4.170e-06
  # Mannitol = 0.003480
  # Saline = 0.7529
# Within-substrate season kruskal-wallis test
p.adjust(c(0.06165, 0.7235, 0.05151, 0.2417, 0.078, 0.0318), method="BH")
  # Inulin ABX = 0.11700
  # Inulin No ABX = 0.72350
  # Mannitol ABX = .11700
