...
colnames(boot.df) <- c("AUC_sqrt", "Antibiotics")
abc.ci(boot.df, leveneTest, y = boot.df$AUC_sqrt, group = boot.df$Antibiotics, center = "median")

abc.ci(boot.df, var, strata = boot.df$Antibiotics)
...
var.test(AvgD ~ Antibiotics, crds.inu.s)
  # p = 0.0041
wilcox.test(AvgD ~ Antibiotics, crds.inu.s)
  # p = 0.006061
...
fligner.test(AvgD ~ Antibiotics, crds.inu.w)
  # p = 0.01802
wilcox.test(AvgD ~ Antibiotics, crds.inu.w)
  # p = 0.07284
...
var.test(AvgD ~ Antibiotics, crds.inu.p)
  # p = 4.256e-06
wilcox.test(AvgD ~ Antibiotics, crds.inu.p)
  # p = 0.001166
...
fligner.test(AvgD ~ Antibiotics, crds.sal.w)
  # p = 0.7543
wilcox.test(AvgD ~ Antibiotics, crds.sal.w)
  # p = 0.01732
